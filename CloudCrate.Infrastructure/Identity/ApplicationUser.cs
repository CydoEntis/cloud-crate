...
public class ApplicationUser : IdentityUser
{
    ...
    [NotMapped] public long AccountStorageLimitBytes => PlanStorageLimits.GetLimit(Plan);

    [NotMapped] public long RemainingAllocationBytes => AccountStorageLimitBytes - AllocatedStorageBytes;

    [NotMapped] public long RemainingUsageBytes => AccountStorageLimitBytes - UsedStorageBytes;
    ...
    public bool IsRefreshTokenActive => RefreshTokenExpires > DateTime.UtcNow;
